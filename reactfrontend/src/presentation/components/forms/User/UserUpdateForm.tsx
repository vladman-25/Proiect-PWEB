 ...
 */
export const UserUpdateForm = (props: { onSubmit?: () => void, entry?: UserDTO }) => {
    const { formatMessage } = useIntl();
    const { state, actions, computed } = useUserUpdateFormController(props.onSubmit, props.entry); // Use the controller.
