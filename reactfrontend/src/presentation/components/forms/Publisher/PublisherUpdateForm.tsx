...
import { usePublisherUpdateFormController } from "./PublisherUpdateForm.controller";
 ...
 */
export const PublisherUpdateForm = (props: { onSubmit?: () => void, entry?: PublisherDTO }) => {
    const { formatMessage } = useIntl();
    const { state, actions, computed } = usePublisherUpdateFormController(props.onSubmit, props.entry); // Use the controller.
