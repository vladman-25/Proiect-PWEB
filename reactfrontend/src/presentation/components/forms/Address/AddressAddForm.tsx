...
import { useAddressAddFormController } from "./AddressAddForm.controller";
 ...
 */
export const AddressAddForm = (props: { onSubmit?: () => void }) => {
    const { formatMessage } = useIntl();
    const { state, actions, computed } = useAddressAddFormController(props.onSubmit); // Use the controller.
