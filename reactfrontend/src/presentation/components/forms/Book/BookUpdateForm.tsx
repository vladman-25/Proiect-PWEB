...
import { useBookUpdateFormController } from "./BookUpdateForm.controller";
 ...
 */
export const BookUpdateForm = (props: { onSubmit?: () => void, entry?: BookDTO }) => {
    const { formatMessage } = useIntl();
    const { state, actions, computed } = useBookUpdateFormController(props.onSubmit, props.entry); // Use the controller.
